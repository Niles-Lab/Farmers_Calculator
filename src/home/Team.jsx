...
let team = [
  ...
  ["bholtzman.png", <p>Beth Holtzman is a senior outreach professional with the University of Vermont Extension. As coordinator of the University of Vermont Extension <a rel="noreferrer" target="_blank" href="https://blog.uvm.edu/newfarmer/">New Farmer Project</a> and <a rel="noreferrer" target="_blank" href="https://www.uvm.edu/extension/agriculture/womens-agricultural-network">Women’s Agricultural Network</a> (WAgN), she has developed and managed education programs that help farmers achieve greater viability, resilience and satisfaction with their businesses and their quality of life. Since 2018, she has also served as the <a rel="noreferrer" target="_blank" href="https://blog.uvm.edu/vtsare/">Northeast SARE state coordinator for Vermont</a>. Email: beth.holtzman@uvm.edu</p>, "", ""],

  ["chricko.png", "Carolyn Hricko is a Food Systems PhD student at the University of Vermont. Her research interests include the interactions between diet, health, agriculture and the environment, and the role of policy in supporting a more just, sustainable food system.", "Keith MacDonald", ""],
  ["elane.jpg", "Erin Lane has worked for the USDA Forest Service for 25 years, and has just started studying soil carbon.  She is the Coordinator of the USDA Northeast Climate Hub. The Hub focuses on communicating how we can adapt our farms and forests to climate change, and how working lands can contribute to climate mitigation. Her research is aimed at finding solutions to climate change by storing carbon in the soil. Erin is passionate about collaborating on teams and developing partnerships.", "", ""]

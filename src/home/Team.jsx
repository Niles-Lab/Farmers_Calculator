...
let team = [
  ...
  ["tharrold.jpg", <p><b>Tim Harrold</b> is an undergraduate Computer Science student at the University of Vermont. He is interested in data visualization, and exploring ways to apply computing concepts in interdisciplinary studies. He has completed data visualization projects using methods such as speech analysis and graph theory. Current projects include designing this website, and exploring different visual and algorithmic approaches to modeling crop diversity and nutritional stability.</p>, "", ""],
